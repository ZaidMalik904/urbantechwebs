  ...
  const steps = [
    {
      ...
      icon: Search,
      desc: "We discuss your business, audience, goals and website requirements.",
    ...
    },
    {
      ...
      icon: Map,
      desc: "We decide the pages, structure, features and content requirements.",
    ...
    },
    {
      ...
      icon: Paintbrush,
      desc: "We create the visual design, user experience, and develop it into a functional, responsive website.",
    ...
    },
    {
      ...
      title: "Testing",
      icon: CheckCircle2,
      desc: "We test the website across devices and check forms, links, responsiveness and performance.",
    ...
    },
    {
      ...
      title: "Launch",
      icon: Rocket,
      desc: "We connect the domain, hosting and SSL and deploy the website.",
    ...
    },
    {
      ...
      title: "Support",
      icon: Clock,
      desc: "Post-launch support is provided according to the selected package or agreement.",
      image: "/images/process_step_1.jpg",
      badge: "Maintenance",
