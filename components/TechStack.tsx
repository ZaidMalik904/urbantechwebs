...
export default function TechStack() {
  const row1Tech = [
    {
      ...
      logo: (
        <div className="relative w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0">
          <Image src="/uploaded_react.png" alt="React" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0">
          <Image src="/uploaded_nextjs.png" alt="Next.js" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-20 h-10 sm:w-24 sm:h-12 flex-shrink-0">
          <Image src="/uploaded_nodejs_v2.png" alt="Node.js" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0">
          <Image src="/uploaded_typescript.png" alt="TypeScript" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-20 h-10 sm:w-24 sm:h-12 flex-shrink-0">
          <Image src="/uploaded_js.png" alt="JavaScript" fill className="object-contain" />
        </div>
      ),
    },
  ];
  ...
  const row2Tech = [
    {
      ...
      logo: (
        <div className="relative w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0">
          <Image src="/uploaded_wordpress.png" alt="WordPress" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-20 h-10 sm:w-24 sm:h-12 flex-shrink-0">
          <Image src="/uploaded_php.png" alt="PHP" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-20 h-10 sm:w-24 sm:h-12 flex-shrink-0">
          <Image src="/uploaded_laravel.png" alt="Laravel" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0">
          <Image src="/uploaded_mongodb.png" alt="MongoDB" fill className="object-contain" />
        </div>
      ),
    },
    {
      ...
      logo: (
        <div className="relative w-20 h-10 sm:w-24 sm:h-12 flex-shrink-0">
          <Image src="/uploaded_mysql.png" alt="MySQL" fill className="object-contain" />
        </div>
      ),
    },
  ];
  ...
  return (
    <section id="tech-stack" className="pt-10 sm:pt-14 pb-24 sm:pb-32 bg-slate-50 text-slate-900 relative border-y border-slate-200 overflow-hidden">
      ...
      <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 space-y-3">
          ...
          <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-medium">
            Handcoded web applications, modern frameworks, and robust databases engineered for sub-2s speed and reliability.
          </p>
        </div>

        <div className="space-y-12 sm:space-y-16 marquee-container">
          
          {/* Row 1: 5 Logos Auto-Animates Left-to-Right (Rightward) */}
          ...
          {/* Row 2: 5 Logos Auto-Animates Right-to-Left (Leftward) */}
